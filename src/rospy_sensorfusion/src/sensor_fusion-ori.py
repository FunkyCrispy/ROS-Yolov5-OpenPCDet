...
def yolov5_parse_cfg():
	parser = argparse.ArgumentParser()
	# solve roslaunch problem
	# parser.add_argument('--__name:', nargs='+', type=str, default=None, help='solve roslaunch default args problem')
	# parser.add_argument('--__log:', nargs='+', type=str, default=None, help='solve roslaunch default args problem')
	parser.add_argument('--weights', nargs='+', type=str, default='/home/fengchen/projects/ros-yolov5-pointpillar/src/rospy_sensorfusion/src/yolov5/weights/yolov5s.pt', help='model.pt path(s)')
...
def openpcdet_parse_cfg():
	parser = argparse.ArgumentParser(description='arg parser')
	parser.add_argument('--cfg_file', type=str, default='/home/fengchen/projects/ros-yolov5-pointpillar/src/rospy_sensorfusion/src/OpenPCDet/tools/cfgs/rod_models/pointpillar_fc.yaml',
		help='specify the config for demo')
	parser.add_argument('--ckpt', type=str, default='/home/fengchen/projects/ros-yolov5-pointpillar/src/rospy_sensorfusion/src/OpenPCDet/output/kitti_models/pointpillar_fc/default/ckpt/checkpoint_epoch_80.pth', help='specify the pretrained model')
	parser.add_argument('--data_path', type=str, default='/home/fengchen/projects/ros-yolov5-pointpillar/src/rospy_sensorfusion/src/OpenPCDet/data/rod/testing/velodyne',
...
# params setting
yolov5_cfg = yolov5_parse_cfg()
openpcdet_cfg, cfg = openpcdet_parse_cfg()
