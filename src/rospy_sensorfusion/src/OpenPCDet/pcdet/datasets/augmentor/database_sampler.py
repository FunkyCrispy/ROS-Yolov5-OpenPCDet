...
# import sys
# sys.path.append('/home/fengchen/projects/OpenPCDet-master/pcdet/ops/iou3d_nms/')
...
# before sampling, already done the two tasks below
# filter_by_difficulties
...
class DataBaseSampler(object):
    ...
    def put_boxes_on_road_planes(gt_boxes, road_planes, calib):
        ...
        # mv_height = z - h/2 - lidar_height, then subtract it to place box bottom face on the ground
    ...
    # add sampled bbox to scene (augmentation), thus some func about shared dataset are above
    # calculate iou with already exist bbox, and choose whether to add that box to scene
    def __call__(self, data_dict):
        ...
        for class_name, sample_group in self.sample_groups.items():
            ...
            if int(sample_group['sample_num']) > 0:
                ...
                # choose where iou1 and iou2 both are zeros
